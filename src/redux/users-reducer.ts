...
const TOGGLE_IS_FETCHING = 'user-reducer/TOGGLE-IS-FETCHING'
const TOGGLE_IS_FOLLOWING_PROGRESS = 'user-reducer/TOGGLE-IS-FOLLOWING-PROGRESS'
const FOLLOW_UNFOLLOW = 'user-reducer/FOLLOW_UNFOLLOW'